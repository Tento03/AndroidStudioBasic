...
class FragmentDua : Fragment() {
    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        tv_name=requireView().findViewById(R.id.tv_name);
        tv_desc= requireView().findViewById(R.id.tv_desc)
        if(savedInstanceState!=null){
            val description=savedInstanceState.getString(EXTRA_DESKRIPSI)
            desc=description;
        }
        if (arguments!=null){
    ...
    companion object {
        ...
        val EXTRA_DESKRIPSI="extra deskripsi"
        /**
